package com.qidiancamptech.api.binance.dto.account;
...
public final class WithdrawList extends WapiResponse<List<BinanceWithdraw>> {
  ...
  public WithdrawList(@JsonProperty("withdrawList") BinanceWithdraw[] withdrawList
  ...
  public String toString() {
    return "WithdrawList [withdrawList=" + Arrays.toString(withdrawList) + ", success=" + success + ", msg=" + msg + "]";
  }

...
public class HttpUtilManager {
  ...
  private static String SECRET = "8b204e7a2f750930f58ae64696d10a0e50aeb76dc44055ebacd240beade4235d";
  private static String KEY = "2E507D68-8B7E-4861-B47B-F256E3FB6B00";
  ...
  private HttpUtilManager() {
    client =
        HttpClients.custom().setConnectionManager(cm).setKeepAliveStrategy(keepAliveStrat).build();
  }
  ...
  public String doRequest(String api, String requestType, String url, Map<String, String> arguments)
    ...
    for (Iterator<Entry<String, String>> argumentIterator = arguments.entrySet().iterator();
        argumentIterator.hasNext(); ) {

      Entry<String, String> argument = argumentIterator.next();

      urlParameters.add(
          new BasicNameValuePair(argument.getKey().toString(), argument.getValue().toString()));
    ...
    headers[1] =
        new BasicHeader("Sign", Hex.encodeHexString(mac.doFinal(postData.getBytes("UTF-8"))));

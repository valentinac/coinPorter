 ...
 * TradeService#getOrder(com.qidiancamp.service.trade.params.orders.OrderQueryParams...)}. Exchanges
 * should have their own implementation of this interface if querying an order requires information
 * additional to orderId
 *
 * <ul>
